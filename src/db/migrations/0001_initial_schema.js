...
//
// This SQL mirrors src/db/schema.sql. schema.sql is the human-readable
// reference for the current database shape; this file is what the migration
// runner applies. Keep the two in sync — the migration-runner test asserts
// that applying this migration yields the tables defined in schema.sql.

export const migration = {
  version: 1,
  name: 'initial_schema',
  sql: `-- 0001 initial_schema
